...
xy = np.loadtxt('/home/sseung/01.Coding/18_D_Apple/Data/csv/output_017800.csv', delimiter=',')
...
cells = rnn.MultiRNNCell([lstm_cell() for _ in range(5)], state_is_tuple=True)
...
with tf.Session() as sess:
    ...
    # Plot predictions
    plt.plot(testY) #True
    plt.plot(test_predict) #Prediction
